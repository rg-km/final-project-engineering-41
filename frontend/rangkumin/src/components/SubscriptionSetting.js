...
export default function SubscriptionSettings() {
	return (
		<Container>
			...
			<h5 style={{ color: "gray", marginBottom: "4%" }}>
			...
			<Row xs={1} md={2} className="g-4 d-flex justify-content-center">
				<Card
					style={{
						margin: "20px",
						backgroundColor: "rgba(245, 81, 57, 0.12)",
						borderColor: "#F55139",
						width: "45%",
						marginBottom: "40px",
					}}
					...
					<Card.Body>
						...
						<Card.Text style={{ color: "gray" }}>23 days Remaining</Card.Text>
						<Button
							style={{
				...
				<Card
					...
					<Card.Body>
						...
						<Card.Text style={{ color: "white" }}>23 days Remaining</Card.Text>
						<Button
							style={{
			...
			<hr></hr>
			<h2 style={{ fontWeight: "bold" }} className="mt-4 mb-4">
				Payment History
			</h2>
			<Table>
				...
				<tbody>
					<tr>
						...
						<td>Rp. 6000</td>
						<td>
							<a style={{ textDecoration: "none", color: "#F55139" }} href="#">
								Invoice 12 July
							</a>
						</td>
					</tr>
