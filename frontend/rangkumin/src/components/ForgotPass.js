		...
		<div style={{ alignItems: "center" }} className="bg-forgot">
			{!show && (
				<Card style={{ width: "20rem", borderRadius: "10px" }}>
					<Card.Body>
						<Card.Title>
							<img style={{ width: "250px" }} src={headForgot}></img>
						</Card.Title>
					</Card.Body>
					<InputGroup
						style={{ padding: 20, marginTop: "-10px" }}
						className="mb-1">
						<InputGroup.Text
							style={{ backgroundColor: "white" }}
							id="basic-addon1">
							<img style={{ alignItems: "center" }} src={mailForgot}></img>
						</InputGroup.Text>
						<Form.Control
			...
			<Alert
				...
				<p>Kami telah mengirimkan email ke alamat email anda.</p>
