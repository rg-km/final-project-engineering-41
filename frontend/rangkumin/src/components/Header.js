                    ...
                    <div>
                        ...
                        <Navbar.Collapse id="basic-navbar-nav">
                            <Nav className='text-end'>
                                <Nav.Link href="#" className='px-3' style={{ color: "white" }}>Home</Nav.Link>
                                <Nav.Link href="#" className='px-3' style={{ color: "white" }}>Course</Nav.Link>
                                <Nav.Link href="#" className='px-3' style={{ color: "white" }}>About Us</Nav.Link>
                            </Nav>
                        </Navbar.Collapse> 
                    </div>
                    {/* kalo login berubah */}
