...
function Homepage() {
	...
	return (
		<>
					...
					<Row className="align-items-center">
						<Col>
							<div className="hero-text py-5">
								<div style={{ width: "60%" }}>
									<div
										aria-label="popUp-newCourses"
										className="popUp-newCourses d-flex justify-content-start p-1">
										<span className="badge rounded-pill align-middle">New</span>
										<label className="px-2 fw-bold text-white">
											Rumus Bangun Datar 2 Dimensi
										</label>
									</div>
								</div>
								<label className="hero-title fw-bold text-white">
									Lorem ipsum dolor sit amet.
								</label>
								<p className="text-white hero-sub">
									Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
									tristique vulputate laoreet. In consectetur ultrices urna sed
									pulvinar. Etiam at porttitor orci. Vivamus interdum lacus.
								</p>

								<button
									onClick={navigateToCourse}
									className="btn-Custom px-4 p-2">
									See Courses
								</button>
								<button
									onClick={navigateToSubscribe}
									className="btn-Custom px-4 mx-4 p-2">
									Berlangganan
								</button>
							</div>
						</Col>
			...
			<Container className="mt-5">
				...
				<div className="text-center mb-5">
					...
					<div className="position-relative">
						...
						<Row>
							{courses.slice(0, 4).map((course, id) => (
								<>
									<Col className="d-flex justify-content-center">
										<Card
											style={{ width: "16rem" }}
											className="card-Custom mb-5 p-2 text-start">
											<Card.Img
												variant="top"
												src={contentCard}
												className="img-fluid rounded"
											/>
											<Card.Title className="fw-bold fs-6 mt-2">
												{course.NamaMateri}
											</Card.Title>
											<div className="d-flex justify-content-between">
												<div className="mt-4">
													<TbMathSymbols
														...
														style={{ color: "#F55139" }}
													/>
													<label>{course.NamaSubject}</label>
												</div>
												<div className="mt-4 ps-2">
													<Link
														key={id}
														to={`/courseDetail/${course.ID}`}
														className="text-decoration-none fw-bold card-Text ">
														See More...
													</Link>
												</div>
											</div>
			...
			<Container
				fluid
				className="mt-Custom10"
				style={{ background: "#EBE7D9" }}>
				<Container>
					<div className="hero-About my-5 d-flex p-5 ">
						...
						<div className="hero-Left-Content ps-4">
							<h2 className="fw-bold mb-3" style={{ fontSize: "48px" }}>
								Praesent pharetra hendrerit dapibus. Integer.
							</h2>
					...
					<div className="position-relative d-flex">
						<div
							className="position-absolute top-0 start-50 translate-middle mb-5"
							style={{ width: "100%" }}>
							<Row className="">
								<Col className="d-flex justify-content-center">
									<Card className="card-Categories" style={{ width: "60%" }}>
										<Card.Body>
											<Card.Img
												variant="top"
												src={SD}
												className="rounded mx-auto p-2 d-block"
												style={{ width: "50%" }}
											/>
			...
			<Container>
				...
				<div className="mt-Custom20 text-center mb-5">
					...
					<div align="center" className="mb-4">
						<div className="subs-Month p-1" style={{ width: "15%" }}>
							<div className="btn-Custom fw-bold">Monthly</div>
						</div>
					</div>
				...
				<div className="Banner-Container mt-Custom10 d-flex justify-content-center">
					<div className="Banner-Content p-5 d-flex">
						<div className="Banner-Content-Text align-middle">
							...
							<p>
								Vivamus luctus nibh eget interdum eleifend. Curabitur suscipit
								elementum semper.
							</p>
							<button
				...
				<div className="Latest-Container mt-Custom10">
					<div className="d-flex justify-content-between mb-4">
						...
						<div>
							<button
								className="btn-Custom py-2 px-4"
								onClick={navigateToCourse}>
								See More...
							</button>
						</div>
